#This file is a script to generate training and validation data for the neural network. The data consists of two classes.
#The two classes consist of pairs of spatial fields and parameters. In the first class, the spatial field is paired with
#the parameter with which the spatial field was generated and in the second class, the spatial field is paired with
#a permuted parameter so that the paired parameter and spatial field are independent.
...
#total number of parametrs (number of rows in parameter_matrix)
...
parameter_matrix <- 2.5*randomLHS(number_of_parameters, 2)
...
#name for the created json files (in this case, data for validation)
file_location <- paste("/home/juliatest/Desktop/likelihood_free_inference/neural_likelihood/gaussian_process", 
                       "nn/models/25_by_25/final_version/data/validation/validation_data_expanded_parameter_space_25_by_25_3000_rep_50", sep = "/")
...
clusterExport(cluster, c("grid_dataframe", "n", "parameter_matrix",
                         "number_of_replicates", "false_indices_matrix", "generate_nn_data_per_parameter_pair",
                         "compute_exponential_kernel_fast", "generate_gaussian_process", "norm_matrix", "write_json",
                         "file_location"))
