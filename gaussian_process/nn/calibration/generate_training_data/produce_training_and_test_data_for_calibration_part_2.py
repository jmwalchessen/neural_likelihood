#This python script is for processing the json files produced from produce_training_and_test_data_for_calibration_part_2.R into numpy matrices for calibration
import json
import numpy as np
...
folder_name = "data/25_by_25/final_version/train"
#
file_name = "train_data_25_by_25_3000_rep_50"
...
file_name_for_images_matrix = (folder_name + "/precalibration_train_images_25_by_25_3000_reps_50.npy")
file_name_for_parameters_matrix = (folder_name + "/precalibration_train_parameters_25_by_25_3000_reps_50.npy")
file_name_for_classes_matrix = (folder_name + "/precalibration_train_classes_25_by_25_3000_reps_50.npy")
