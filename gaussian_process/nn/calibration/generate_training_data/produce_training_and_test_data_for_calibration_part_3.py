...
number_of_reps = 50
#load training images and parameters
train_images_file = (local_folder + "nn/calibration/data/" + image_name + "/" + version + 
                    "/" + train_or_test + "/precalibration_" + train_or_test + "_images_" +
                      str(number_of_parameters) + "_reps_" + str(number_of_reps) + ".npy")
train_images = np.load(train_images_file)
train_parameters_file = (local_folder + "nn/calibration/data/" + image_name + "/" + version + "/"
                         + train_or_test + "/precalibration_" + train_or_test + "_parameters_" + 
                         str(number_of_parameters) + "_reps_" + str(number_of_reps) + ".npy")
...
json_file_name = (local_folder + "nn/models/" + image_name + "/" +  version 
 + "/model/" + "gp_" + str(image_name) + "_" + version + "_nn.json")
...
np.save((local_folder + "nn/models/calibration/data/" + image_name + "/" + version + "/" + train_or_test
