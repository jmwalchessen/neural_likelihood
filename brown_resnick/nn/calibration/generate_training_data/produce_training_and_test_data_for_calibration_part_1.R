                                         ...
                                         cov.type)
{
  ...
  data_list_name <- paste(paste(paste(paste(paste(paste(paste(paste(paste(paste(paste(paste(local_folder, "nn/calibration/data", sep = "/"), 
                                                  image_name, sep = "/"), version, sep = "/"), train_or_test, sep = "/"), train_or_test, sep = "/"),
                                                  "samples", sep = "_"), image_name, sep = "_"), as.character(number_of_parameters), sep = "_"),
                                                  "reps", sep = "_"), as.character(number_of_reps), sep = "_"), as.character(observation_number), 
                                                  sep = "_"), "json", sep = ".")
...
clusterExport(cluster, c("nn", "coord", "ranges", "smooths", "data_y", "simu_samp_per_parameter_pair", "number_of_parameters", "train_or_test",
                         "number_of_reps", "cov.type", "rmaxstab", "write_json", "false_indices_matrix", "local_folder", "image_name", "version"))
