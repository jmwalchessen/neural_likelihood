...
def produce_max_psi_parameters(possible_ranges, possible_smooths, psi_field):
...
for i in range(0, number_of_parameters):
    for j in range(0, number_of_reps):
        ...
        single_max_params[i,j,:] = produce_max_psi_parameters(possible_ranges, possible_smooths, 
...
for i in range(0, number_of_parameters):
    for j in range(0, number_of_reps):
        ...
        multi_max_params[i,j,:] = produce_max_psi_parameters(possible_ranges, possible_smooths, 
